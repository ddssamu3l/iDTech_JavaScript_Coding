...
createSentence.apply(this,words);
// TODO: Create an empty string variable called "sentence".
// YOUR CODE GOES HERE
var sentence=""; // I added (="") because (var sentence;) would print with an "undefined" in front of the string. I don't know if this is the correct way to fix this problem
